...
export const ProductUpdateOneSchema: z.ZodType<Prisma.ProductUpdateArgs> = z.object({ select: ProductSelectObjectSchema.optional(),  data: z.union([ProductUpdateInputObjectSchema, ProductUncheckedUpdateInputObjectSchema]), where: ProductWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ProductUpdateArgs>;

export const ProductUpdateOneZodSchema = z.object({ select: ProductSelectObjectSchema.optional(),  data: z.union([ProductUpdateInputObjectSchema, ProductUncheckedUpdateInputObjectSchema]), where: ProductWhereUniqueInputObjectSchema }).strict();